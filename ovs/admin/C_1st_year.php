...
$position = '1st Year Representative'; // Change for each position file
...
<div class="modern-tab-bar">
    ...
    <?php
    // Get 1st Year Representative candidates for Excel download
    $query = mysqli_query($conn, "SELECT * FROM candidate WHERE Position='1st Year Representative' LIMIT 1");
