...
$position = '2nd Year Representative'; // Change for each position file
...
<div class="modern-tab-bar">
    ...
    <?php
    // Get 2nd Year Representative candidates for Excel download
    $query = mysqli_query($conn, "SELECT * FROM candidate WHERE Position='2nd Year Representative' LIMIT 1");
