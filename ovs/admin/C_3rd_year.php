...
$position = '3rd Year Representative'; // Change for each position file
...
<div class="modern-tab-bar">
    ...
    <?php
    // Get 3rd Year Representative candidates for Excel download
    $query = mysqli_query($conn, "SELECT * FROM candidate WHERE Position='3rd Year Representative' LIMIT 1");
